...
DATA_PATH = path_pc + 'outcomesmiddle_new_features_2025-10-23.csv'
...
with open(path_pc + 'middlefeatures_list.txt', 'r', encoding='utf-8') as f:
...
# 贏率（只要賣出不是因止損（trailing_stop或stop_loss），都算勝）
