...
# 股票清單（中波動九支）
TAIWAN_SYMBOLS = [
    '2886.TW', '2317.TW', '1216.TW', '2395.TW', '1101.TW', '2382.TW', '4958.TW', '2356.TW', '3711.TW'
]
...
model.save_model(path_pc + 'lightgbm_middle_recall_model.txt')
with open(path_pc + 'middlefeatures_recall_list.txt', 'w', encoding='utf-8') as f:
    for col in features:
        f.write(col + '\n')
